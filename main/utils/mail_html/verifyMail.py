def verifyMail(encrypted_mail, last_name, first_name, url):
    return '''
<!DOCTYPE html>
<html>
<head>
                        ...
                        <tr>
                          <td class="sm-px-24"
                            ...
                            <p style="margin: 0 0 24px;">
                              Доорх товчийг дарж имэйл хаягаа баталгаажуулж, манай хүний нөөцийн системд нэгдээрэй.
                            </p>
                            <p style="margin: 0 0 24px;">
                              Хэрэв та HRms.mn-д бүртгүүлээгүй бол энэ имэйлийг үл тоомсорлож болно.
                            </p>
                              ...
                              <tbody>
                                <tr>
                                  <td
                                    ...
                                    <a href='{}/account/verifymail/?token={}'
                                      style="display: block; font-weight: 600; font-size: 14px; line-height: 100%; padding: 16px 24px;  color: #ffffff; color: rgb(255, 255, 255); ">Баталгаажуулах</a>
                                  </td>
                                </tr>
                              </tbody>
                            </table>
