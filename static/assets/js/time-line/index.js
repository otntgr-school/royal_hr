...
jQuery.fn.timelinev = function(options){
    ...
    $(function() {
        ...
        // //Bind scroll
        $(settings.dateDiv).bind('mousewheel DOMMouseScroll', function (event) {
            event.preventDefault();
        ...
        function decrementDate(){
            $(divsCont[dateActive-1]).animate({ 'margin-top': "-"+divsCont.outerHeight() }, {queue:true, duration:'settings.datesSpeed'});
        }
